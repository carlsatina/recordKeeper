...
<style scoped>
.body-weight-container { min-height: 100vh; background: #05060a; position: relative; overflow: hidden; padding-bottom: 100px; }
...
.status-badge { padding: 6px 14px; border-radius: 12px; font-size: 13px; font-weight: 700; border: 1px solid rgba(255,255,255,0.12); color: #cbd5e1; }
